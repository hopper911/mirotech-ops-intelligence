...
const SAMPLE = "Sample data · Northline Commerce · concept demo";
...
const recommendations: Recommendation[] = [
  ...
  },
  {
    ...
    issue: "Support summarization uses GPT-4o for 72% of tickets where gpt-4o-mini matches quality gates.",
    evidence: [
...
function executive(): ExecutiveDashboard {
  return {
...
export const SAMPLE_DATA_LABEL = SAMPLE;
